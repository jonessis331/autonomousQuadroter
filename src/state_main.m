%% Introduction
% Main function for Aerospace Autonomy final project
...
% the model. Possible arguments: 2, 3, 5.
% I WILL BE RUNNING YOUR CODE SO PLEASE KEEP THIS MAIN FUNCTION CALL 
...
function [act_state_matrix, act_des_matrix, timev] = state_main(question)
...
state = zeros(16,1); % 12 rigid body states + 4 motor_rpm
...
act_state_matrix = actual_state_matrix;
act_des_matrix = actual_desired_state_matrix;
timev = time_vec;
